...
(1, 'MAC Address', 'regex:/^[a-fA-F0-9]{2}:[a-fA-F0-9]{2}:[a-fA-F0-9]{2}:[a-fA-F0-9]{2}:[a-fA-F0-9]{2}:[a-fA-F0-9]{2}$/', 'text', NULL, '2024-12-24 02:43:56', NULL, NULL, 0, '_snipeit_mac_address_1', NULL, 0, 0, 0, 0, 0, 0);
...
(1, '2024-12-24 02:49:58', '2024-12-25 04:37:07', 1, 20, 'Sangkaj Group', NULL, NULL, NULL, NULL, NULL, 1, NULL, 1, 'setting-logo-1-JYQyewlQ6k.jpg', NULL, 'you@example.com', 1, NULL, 'QRCODE', NULL, NULL, NULL, 'slack', 'INR', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'samaccountname', 'sn', 'givenname', 'uid=', 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 'en-US', 30, 2.62500, 1.00000, 0.21975, 0.21975, 0.50000, 0.50000, 0.07000, 0.05000, 9, 8.50000, 11.00000, 0, 1, 1, 'C128', 1, 30, 5, 'first_last', 'gmail.com', 'filastname', 'filastname', 0, NULL, '389', 0, 5, 1, NULL, 0, 'Y-m-d', 'h:i A', 1, NULL, 50, 0, NULL, 10, NULL, NULL, 0, NULL, 1, 0, 0, NULL, 'on', NULL, 'image,category,manufacturer,model_number', 0, 0, '', 'blue', 1, NULL, 0, NULL, 'on', 0, 0, 'default', 'setting-favicon-1-AmTymdto8t.ico', 'default.png', 'setting-email_logo-1-KE4TRbKTd9.jpg', 'setting-label_logo-1-usGSnRDmld.jpg', 0, 0, '', 0, 0, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, '1,234.56', NULL, NULL, 'name', 0, 'DefaultLabel', NULL, 0, 'default', 'default', 'hardware_id', 'name=name;serial=serial;model=model.name;', 0, NULL, NULL, 1, 0, NULL);
